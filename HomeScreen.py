...
class HomeScreen(pygame.sprite.Sprite):
    global screen_state
    def __init__(self):
        self.playing_button = Button(WIDTH / 2, 500, 150, 150, 'playing_button')  
        self.setting_button = Button(WIDTH/2 + 200 , 500, 110, 110, 'setting_button')
        ...
        self.screen.add(self.greeting_text, self.setting_button, self.playing_button)
